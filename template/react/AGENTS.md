...
- Keep raw Synapse SDK calls inside `src/lib/foc/adapter.ts` and the Node-only smoke script.
...
- Never expose private keys through `VITE_*`, React props, logs, or browser bundles.
